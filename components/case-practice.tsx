...
import { Mic, MicOff, RotateCcw, ArrowLeft, BarChart3, MessageCircle } from "lucide-react"
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-3">
              <div className="w-8 h-8 bg-gradient-to-br from-orange-400 to-orange-500 rounded-lg flex items-center justify-center">
                <Image src="/rafi-mascot.png" alt="Rafi" width={24} height={24} className="rounded" />
              </div>
        ...
        <Card className="border-orange-200 shadow-xl">
          <CardContent className="p-8">
            <div className="text-center space-y-8">
              {/* Rafi Avatar */}
              <div className="relative">
                <div className="w-24 h-24 mx-auto bg-gradient-to-br from-orange-400 to-orange-500 rounded-3xl flex items-center justify-center shadow-lg">
                  <Image src="/rafi-mascot.png" alt="Rafi listening" width={80} height={80} className="rounded-2xl" />
                </div>
                {isRecording && (
              ...
              <div className="space-y-4">
                <h3 className="text-2xl font-semibold text-gray-900">
                  {isRecording ? "Rafi is listening..." : "Ready to start your case interview?"}
                </h3>
              ...
              <div className="space-y-6">
                ...
                <p className="text-sm text-gray-500">
                  {isRecording ? "Click the microphone again to stop recording" : "Click to start recording"}
                </p>
              </div>
            </div>
          </CardContent>
